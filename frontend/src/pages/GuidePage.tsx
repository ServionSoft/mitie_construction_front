const PHASES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { label: 'Link the parcel to your project' },
      { label: 'Also record cost in Expenses → category Land Purchase (stamp duty, fees)' },
    ],
  ...
  },
  {
    ...
    tip: 'Only Posted journals feed TB, GL, and Balance Sheet.',
  },
  {
    phase: '11',
